            ...
            {searchInput && (
                <div className="flex flex-col mx-auto col-span-3 border border-red-400 max-w-full overflow-hidden box-border">
                    ...
                    <div className="flex w-full">
                        <button onClick={resetInput} className="flex-grow py-4 text-gray-500">Cancel</button>
                        
                        <button onClick={handleSearch} className="flex-grow py-4 text-red-400">Search</button>
                    </div>
                </div>
            )}
        </header>
